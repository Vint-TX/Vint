...
public class Encryption : IDisposable {
    ...
    public string PublicKey =>
        $"{Convert.ToBase64String(Parameters.Modulus!)}:{Convert.ToBase64String(Parameters.Exponent!)}";
